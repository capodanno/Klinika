			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="registrationDate" title="${message(code: 'admin.registrationDate.label', default: 'Registration Date')}" />
					
						<g:sortableColumn property="secQuestion" title="${message(code: 'admin.secQuestion.label', default: 'Sec Question')}" />
					
						<g:sortableColumn property="secAnswer" title="${message(code: 'admin.secAnswer.label', default: 'Sec Answer')}" />
				...
				<g:each in="${adminInstanceList}" status="i" var="adminInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${adminInstance.registrationDate}" /></td>
					
						<td>${fieldValue(bean: adminInstance, field: "secQuestion")}</td>
					
						<td>${fieldValue(bean: adminInstance, field: "secAnswer")}</td>
